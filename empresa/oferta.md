...
- **Usado por:** el agente de precios del [embudo de diagnóstico](../sistemas/embudo-diagnostico.md).

## Servicios

| Servicio | Qué hacen los agentes | Cómo se mide |
|---|---|---|
...
- **Cuota base mensual** por servicio, más un **variable por socio conseguido o recuperado**.
...
| Servicio | Cuota base (€/mes) | Variable | Piloto 30 días |
|---|---|---|---|
